...
public class KCP
{
    ...
    public int Input(byte[] data, int data_length) {

        var s_una = snd_una;
        if (data_length < IKCP_OVERHEAD) return 0;
        ...
        while (true)
        {
            ...
            if (data_length - offset < IKCP_OVERHEAD) break;
            ...
            if (data_length - offset < length) return -2;
