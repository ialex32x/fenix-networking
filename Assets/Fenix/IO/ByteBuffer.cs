...
namespace Fenix.IO
{
    ...
    {
        public ByteBufferAllocator _allocator;
        ...
        public long ReadInt64()
        {
            ...
            var v = ConvertUtils.ReadInt64(_data, _readPosition);
        ...
        public ulong ReadUInt64()
        {
            ...
            var v = ConvertUtils.ReadUInt64(_data, _readPosition);
            _readPosition += sizeof(long);
            return v;
        }
        ...
        {
            WriteBytes(ConvertUtils.GetBytes(value));
        }
